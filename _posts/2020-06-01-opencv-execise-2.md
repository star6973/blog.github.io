...
---
    ...
    */
    ...
    /*
      ...
      WINDOW_NORMAL: 윈도우 크기의 재조정 가능
      WINDOW_AUTOSIZE: 표시된 행렬의 크기에 맞춰 자동 설정
      WINDOW_OPENGL: OpenGL을 지원하는 윈도우 생성
    ...
    */
    ...
    /*
      ...
      - int radius			: 원의 반지름
      - const Scalar& color	: 선의 색상
      - int thickness = 1		: 선의 두께
      - int lineType = 8		: 선의 형태
      - int shift = 0			: 좌표에 대한 비트 시프트 연산
    ...
    */
    ...
    //과제(오른쪽 클릭할 때마다 사각형, 왼쪽 클릭할 때마다 원을 그리기)
