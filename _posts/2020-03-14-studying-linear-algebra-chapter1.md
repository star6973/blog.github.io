...
### 1.1. 벡터와 공간
#### 1.1.1. 벡터<br>
&nbsp;&nbsp;&nbsp;&nbsp;수치의 조합을 정리하여 나타내는 기법이다. 수를 나열한 것으로, 성분수를 명시하고 싶을 때는 $$\begin{pmatrix} 3 \\ 0 \end{pmatrix}$$ 각각 2차원 벡터, 3차원 벡터로 불린다.
<br><br>
#### 1.1.2. 공간<br>
...
<br>
<img src="/assets/images/studying/chapter1/3.JPG" margin-left: auto; margin-right: auto;>
<br>
