...
- 다음은 FPN이 등장하기 까지의 새로운 형태의 기법들이다.
    ...
    - Featurized Image Pyramid
        <center><img src="/assets/images/reference_image/MH.Ji/DetectorRS/4.PNG" width="60%"></center><br>
    ...
    - Single Feature Map
        <center><img src="/assets/images/reference_image/MH.Ji/DetectorRS/5.PNG" width="60%"></center><br>
    ...
    - Pyramidal Feature Hierarchy
        <center><img src="/assets/images/reference_image/MH.Ji/DetectorRS/6.PNG" width="60%"></center><br>
...
- FPN의 기법 이후, 이를 개선하기 위해 새로운 기법들이 제시 되는데, 최근 논문에서는 EfficientDet에서 제시한 BiFPN이 있다.
    - BiFPN 구조가 등장하기 전까지의 FPN의 새로운 구조들
        ...
        + (a) FPN
            <center><img src="/assets/images/reference_image/MH.Ji/DetectorRS/9.PNG" width="40%"></center><br>

            - 전통적인 FPN 구조로, top-down 방식을 사용한다.

        + (b) PANet
            <center><img src="/assets/images/reference_image/MH.Ji/DetectorRS/10.PNG" width="40%"></center><br>

            - FPN에서 bottom-up을 추가하였다.

        + (c) NAS-FPN
            <center><img src="/assets/images/reference_image/MH.Ji/DetectorRS/11.PNG" width="40%"></center><br>
...
### 6. Experiments
<center><img src="/assets/images/reference_image/MH.Ji/DetectorRS/21.PNG" width="70%"></center><br>
