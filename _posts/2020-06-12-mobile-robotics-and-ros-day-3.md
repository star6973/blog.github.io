...
4. Sensors
    1) Encoders
        ...
        [원리]  
            ...
            - quadrature(구적법) : 구적 위상 편이에서 두 개의 센서를 사용하여, 어떤 웨이브가 상승 에지를 생성하는 지를 알려줌
                                  또한, resolution(해상도)이 4배 더 크다.
    ...
    4) Range sensors
        ...
        4) Triangulation Ranging
            ...
            - Structued Light: RGBD 카메라(RGB, Depth)
              IR 프로젝터: IR bandwidth와 RGB bandwidth를 달리 하여 각각 추출 가능
